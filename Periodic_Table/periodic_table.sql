...
--
-- Name: properties f_key; Type: FK CONSTRAINT; Schema: public; Owner: freecodecamp
--

ALTER TABLE ONLY public.properties
    ADD CONSTRAINT f_key FOREIGN KEY (atomic_number) REFERENCES public.elements(atomic_number);
